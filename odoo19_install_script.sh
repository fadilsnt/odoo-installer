#!/bin/bash
################################################################################
# Script for installing Odoo 19 on Ubuntu 24.04 LTS
# Author: Dinuth Perera
################################################################################
# This script will install Odoo 19 on your Ubuntu 24.04 server with Nginx
# Make a new file:
# sudo nano odoo19-install.sh
# Place this content in it and then make the file executable:
# sudo chmod +x odoo19-install.sh
...
print_status "=============================================="
print_status "Odoo 19 installation completed successfully!"
print_status "=============================================="
